...
kafka-topics.sh --bootstrap-server "${KAFKA_HOST}" --create --if-not-exists --topic raw_scores --replication-factor 1 --partitions 1
kafka-topics.sh --bootstrap-server "${KAFKA_HOST}" --create --if-not-exists --topic realtime_changes --replication-factor 1 --partitions 1
kafka-topics.sh --bootstrap-server "${KAFKA_HOST}" --create --if-not-exists --topic scores_changes_feed --replication-factor 1 --partitions 1
